...
#Matrix
#
FreeThrowsFTA <- rbind(KobeBryant_FTA, JoeJohnson_FTA, LeBronJames_FTA, CarmeloAnthony_FTA, DwightHoward_FTA, ChrisBosh_FTA, ChrisPaul_FTA, KevinDurant_FTA, DerrickRose_FTA, DwayneWade_FTA)
...
colnames(FreeThrowsFTA) <- Seasons
rownames(FreeThrowsFTA) <- Players
#
